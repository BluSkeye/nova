...
namespace ssi
{
    public class RectangleListItem : IObservableListItem
    {
        ...
        private int gender = 0; // 0 male, 1 female, -1 Unknown
        private int age = 0; // -1 unknown, 0 under age, 1 Possible under age, 2 OK
        ...
        public RectangleListItem(int x1, int y1, int x2, int y2, int body_type, int clothing_state, int gender, int age, string label, double confidence)
        {
            this.x1 = x1;
            this.y1 = y1;
            this.x2 = x2;
